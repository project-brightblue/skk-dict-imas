...
generate (){
	...
	sed -f ./src/NAME.sed ./src/FIRSTNAME | skkdic-sort | iconv -f UTF-8 -t EUC-JP > ./SKK-JISYO.imascg.firstname.euc
	cat ./src/FULLNAME | skkdic-sort >> ./SKK-JISYO.imascg.fullname.utf8
	sed -f ./src/NAME.sed ./src/FULLNAME | skkdic-sort | iconv -f UTF-8 -t EUC-JP > ./SKK-JISYO.imascg.fullname.euc
	echo 'done.'

	# actors
	echo 'Generate actors dict...'
	sed -f ./src/NAME.sed ./src/ACTORS | iconv -f UTF-8 -t EUC-JP | skkdic-sort > ./SKK-JISYO.imascg.actors.euc
